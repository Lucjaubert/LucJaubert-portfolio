...
var ContactComponent = function () {
    ...
    var ContactComponent = _classThis = /** @class */ (function () {
        function ContactComponent_1(platformId) {
            this.platformId = platformId;
        }
        ContactComponent_1.prototype.ngAfterViewInit = function () {
            if ((0, common_1.isPlatformBrowser)(this.platformId)) {
                this.initContactAnimations();
            }
        };
        ContactComponent_1.prototype.initContactAnimations = function () {
            var _this = this;
            if ((0, common_1.isPlatformBrowser)(this.platformId)) {
                this.gsapContext = gsap_1.gsap.context(function () {
                    gsap_1.gsap.to(".background-contact", {
                        height: '100%',
                        duration: 1.3,
                        ease: 'expoScale',
                        scrollTrigger: {
                        ...
                        onComplete: function () {
                            _this.animateContactText();
                        }
                    });
                });
            }
        };
        ContactComponent_1.prototype.animateContactText = function () {
            gsap_1.gsap.to(".contact-item, .copyright", {
                opacity: 1,
                y: 0,
                delay: 0.1,
                duration: 0.8,
